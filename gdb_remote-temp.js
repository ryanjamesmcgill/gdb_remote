 ...
 *
 * @original-author Dan Armendariz <danallan AT cs DOT harvard DOT edu>
 * @gdb-arm-author Ryan McGill <ryanjamesmcgill AT gmail DOT com>
 */
define(function(require, exports, module) {
    main.consumes = [
        "Plugin", "debugger", "c9", "panels", "settings", "dialog.error"
    ];
    main.provides = ["gdb_remote"];
    return main;
    ...
    function main(options, imports, register) {
        ...
        var plugin = new Plugin("RJM", main.consumes);
        ...
        // proxy location
        var PROXY = require("text!./netproxy_remote.js");
        ...
        function getProxySource(process){
            ...
            return PROXY
                ...
                .replace(/\{BIN\}/, bin);
                //.replace(/\{PORT\}/,configure.debug_port)
                //.replace(/\{IP\}/,configure.target.ip);
        }
